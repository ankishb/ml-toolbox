...
model_xgb1, imp_xgb1, oof_xgb1, pred_xgb1 = run_cv_xgb(
...
train = h2o.H2OFrame(pd.concat([train_df1, target], axis=1))                     
test  = h2o.H2OFrame(test_df1)
...
oof_xgb1 = np.load('submission/stacking/oof_xgb1.npy')
oof_xgb2 = np.load('submission/stacking/oof_xgb_inter.npy')
oof_xgb3 = np.load('submission/stacking/oof_xgb_inter_3way1.npy')
oof_xgb4 = np.load('submission/stacking/oof_xgb_inter_3way2.npy')

oof_lgb1 = np.load('submission/stacking/oof_lgb1.npy')
oof_lgb2 = np.load('submission/stacking/oof_lgb_inter.npy')
oof_lgb3 = np.load('submission/stacking/oof_lgb_inter_3way1.npy')

oof_ridge = np.load('submission/stacking/oof_ridge1.npy')
oof_logistic = np.load('submission/stacking/oof_logistic1.npy')

oof_dl = pd.read_csv('submission/stacking/dl_model_oof.csv')
oof_dl_deep = pd.read_csv('submission/stacking/dl_model_deep_oof.csv')

oof_drf = pd.read_csv('submission/stacking/drf_model_oof.csv')
oof_drf_deep = pd.read_csv('submission/stacking/drf_model_deep_oof.csv')

oof_gbm = pd.read_csv('submission/stacking/gbm_model_oof.csv')
oof_gbm_deep = pd.read_csv('submission/stacking/gbm_model_deep_oof.csv')

oof_glm = pd.read_csv('submission/stacking/glm_model_oof.csv')
oof_glm_bal = pd.read_csv('submission/stacking/glm_model_inter_oof.csv')
oof_glm_inter = pd.read_csv('submission/stacking/glm_model_bal_oof.csv')


# In[77]:


oofs = np.column_stack([oof_xgb1,oof_xgb2, oof_xgb3, oof_xgb4,
...
oofs = pd.DataFrame(data=oofs, columns=['xgb1', 'xgb2', 'xgb3', 'xgb4',
...
feature-engineering-final-stratified-Copy1.py
